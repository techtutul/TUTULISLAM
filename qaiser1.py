#Script Given By Majharul Islam Tutul
#Script Is Given For Education
#Script Edited By @TOXICTUTUL
#Utf-8 python 
...
qaiserchoice = random.choice(tutul)
agents = [
...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Tech Tutul
...
def main():
    ...
    print ' \033[0m[3].\x1b[1;96m Follow My Page  '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/Love09official/')
        main()
    else:
        print ''
